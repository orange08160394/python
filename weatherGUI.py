...
def printSelection():
    ...
    try:
        ...
        data = None
    report.insert(INSERT,"           "+citylist[var.get()]+"目前氣候報吿\n")
    ...
    report.insert(INSERT,"目前溫度："+str(main["humidity"])+"\n")
    report.insert(INSERT,"最低溫度："+str(main["temp_main"])+"\n")
    report.insert(INSERT,"最髙溫度："+str(main["temp_max"])+"\n")
    report.insert (INSERT,"-"*40)
    
API_key ="d8a277dfb74bd055a8f7758575419451"
country ="TW"
...
label1=Label(win, text="城市即時天氣資訊",pady=6, fg="blue",bg="lightyellow",font=("微軟正黑體",16))
label1.place(x=300,y=10)

var=IntVar()
var.set(0)
citylist = {0:"台北",1:"板橋",2:"桃園",3:"台中",4:"新竹",5:"台南",6:"高雄"}
